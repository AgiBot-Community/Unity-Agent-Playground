...
| `python -m x2_agent.demo` | **先跑通网关**。不依赖云服务，收到语音后回固定文字和正弦提示音，不进行真实识别或语音合成 |
...
连上后机器人先播开场白"你好，我是灵犀，有什么可以帮您？"（doubao 客户端为合成语音；demo 客户端是一声提示音），随后就可以对机器人说：

| 你说 | 机器人做 |
|---|---|
| "挥挥手" | 手臂举起摆动（当前唯一手势） |
| "你开心吗" / "给我比个爱心" / "我有点难过" / "你生气啦" | 头部表情屏切换（共 10 种：开心/思考/惊讶/难过/困倦/眨眼/爱心/生气/抱歉/倾听） |
| "往前走一米" / "向左转" | 步态前进 / 原地转向 |
| "停" | 立即停止 |

说话时机器人表情自动变"倾听"，回答时嘴巴随语音张合。
