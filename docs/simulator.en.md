...
Repackaging does not change Unity's listen address or authentication settings. To change them, obtain an updated Unity build and package that build. The complete Unity source project is not included here.
