...
Les fichiers sans suffixe linguistique sont en chinois ; `.en.md` désigne l’anglais et `.fr.md` le français. Ne traduisez pas les identifiants du protocole, les commandes, les modèles ou les noms de fichiers. Mettez à jour les trois versions lorsque le comportement ou les paramètres changent.
