...
L’empaquetage ne modifie ni l’adresse d’écoute ni l’authentification Unity. Pour les modifier, il faut obtenir un build Unity mis à jour puis l’empaqueter. Le projet source Unity complet n’est pas inclus.
